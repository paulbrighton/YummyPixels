...
class MuttonChaap extends Component {
  render () {
    return <Layout {...this.props}>
      <Head>
        <title>Mutton Chaap - Indian Lamb Chops Recipe by Yummy Pixels</title>
        <meta
          name='description'
          content='A indian battered and fried lamb chop (Mutton Chaap) recipe by Paul Brighton at Yummy Pixels.'
          key='viewport'
        />
      </Head>
              ...
              <div className='c-recipe__image'>
                <figure>
                  <picture>
                    ...
                    <img src='static/Images/food/indian_lamb_chops_hero.jpg' alt='Indian battered lamb chops' />
                  </picture>
                </figure>
              </div>
