...
class Kibbeh extends Component {
  render () {
    return <Layout {...this.props}>
      <Head>
        <title>Middle Eastern Kibbeh Recipe by Yummy Pixels</title>
        <meta
          name='description'
          content='A Middle Eastern Kibbeh recipe that is popular in Brazil by Thais Brighton at Yummy Pixels.'
          key='viewport'
        />
      </Head>
              ...
              <div className='c-recipe__image'>
                <figure>
                  <picture>
                    ...
                    <img src='static/Images/food/kibbeh_hero.jpg' alt='Middle Eastern spiced minced meat and bulgar wheat patties' />
                  </picture>
                </figure>
              </div>
