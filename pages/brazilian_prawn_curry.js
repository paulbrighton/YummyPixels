...
class BrazilianPrawnCurry extends Component {
  render () {
    return <Layout {...this.props}>
      <Head>
        <title>Camarão na Moranga - Prawns in Pumpkin by Yummy Pixels</title>
        <meta
          name='description'
          content='A Brazilian prawn and coconut cream curry called Camarão na Moranga served in pumpkin by Thais Brighton at Yummy Pixels.'
          key='viewport'
        />
      </Head>
