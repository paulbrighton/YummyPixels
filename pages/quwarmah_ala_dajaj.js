...
class QuwarmahAlaDajaj extends Component {
  render () {
    return <Layout {...this.props}>
      <Head>
        <title>Kuwaiti Curried Chicken Recipe by Yummy Pixels</title>
        <meta
          name='description'
          content='A Kuwaiti Curried Chicken (Quwarmah ala Dajaj) recipe cooked with baharat and dried lime by Paul Brighton at Yummy Pixels.'
          key='viewport'
        />
      </Head>
