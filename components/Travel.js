  ...
  render () {
    return <section className='c-travel'>
      ...
      <div className='c-travel__text'>
        ...
        <p>I’d like to start by sharing with you my trip to <Link><a href='/japan_itinerary'>Japan and South Korea</a></Link> that I did in 2014, not only did I get to see Japan but also return to South Korea for some Korean BBQ and checkout some of the sites I missed the first time I visited. The trip includes Tokyo, Kyoto and Seoul along with other interesting places in Japan to visit, all in just over two weeks.</p>
        <p>Keep an eye on the <Link><a href='/travel'>Travel page</a></Link> as I will be updating it regularly with more travel inspiration.</p>
      </div>
    </section>
  }
}
